      ...
      <Grid item md={4} xs={12}>
        ...
        <Stack direction="column" spacing={2}>
          ...
          <TextTypography sx={{ textAlign: "center" }}>
            Cadastre toda a sua equipe no I7ticket. Cada atendente recebe o
      ...
      >
        <CardBox sx={{ zIndex: "30", marginLeft: "auto", marginRight: "auto" }}>
          ...
          >
            ...
            <TextTypography sx={{ textAlign: "center" }}>
              Cada ticket pode ser atribuído a um setor de atendimento,
      ...
      >
        <CardBox sx={{ zIndex: "30", marginLeft: "auto", marginRight: "auto" }}>
          ...
          >
            ...
            <TextTypography sx={{ textAlign: "center" }}>
              Todas as mensagens enviadas pelo I7ticket levam o nome do
        ...
        <CardBox sx={{ zIndex: "30", marginLeft: "auto", marginRight: "auto" }}>
          ...
          >
            <CardSubtitleTypography>
              ...
              Resposta Rápidas no atendimento
            </CardSubtitleTypography>

            <TextTypography sx={{ textAlign: "center" }}>
              Deixe a tecnologia trabalhar por você! Crie respostas automaticas para 
              seus atendimentos. Otimize seu tempo de atendimento.
            </TextTypography>
          </Stack>
        </CardBox>
      </Grid>
